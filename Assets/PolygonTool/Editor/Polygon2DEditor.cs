...
public class Polygon2DEditor : Editor {
	...
	public void OnSceneGUI()
	{
		...
		case State.Modify:
			if (LeftMouseDown)
			{
				int i = ClosestPoint(Event.current.mousePosition);
	...
	private void DrawPolygon2DOutline()
	{	
	...
	// Find the closest point in the polygon - this could be made more generic
	int ClosestPoint(Vector2 position)
	{
	...
	public override void OnInspectorGUI()
	{
		...
		ShapeInspectorGUI(polygon.Polygon2DMesh, "Polygon2D mesh");
		ShapeInspectorGUI(polygon.Polygon2DCollider, "Polygon2D collider");
	...
	public void ShapeInspectorGUI(Polygon2D.ShapeData shapeData, string name)
	{
