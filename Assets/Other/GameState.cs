...
public class GameState : MonoBehaviour {
	...
	public static void init (List<bool> active, string level_to_choose) {
		if (!initialized) {
			...
			levels.Add(new GameLevel(levels.Count(), "MATTER OF CHOICE", 30f, 60f, true, true, true));
			levels.Add(new GameLevel(levels.Count(), "TOWER OF BOX", 30f, 60f, true, true, true));
			levels.Add(new GameLevel(levels.Count(), "SECRET SERVICE", 50f, 100f, true, true, true));
			levels.Add(new GameLevel(levels.Count(), "WAREHOUSE", 65f, 130f, true, true, true));
			levels.Add(new GameLevel(levels.Count(), "RAINY DAY", 30f, 60f, true, true, true));
			levels.Add(new GameLevel(levels.Count(), "STAIRWAY", 45f, 90f, true, true, true));
